...
actionDelegateSelector.insert(1, lambda module, handler, actionName: actionName == "style.text.blockquote",
                              TextStyleBlockQuote)
...
actionDelegateSelector.insert(1, lambda module, handler, actionName: actionName == "style.text.alignCenter",
                              TextStyleAlignCenter)
...
actionDelegateSelector.insert(1, lambda module, handler, actionName: actionName == "style.text.alignLeft",
                              TextStyleAlignLeft)
...
actionDelegateSelector.insert(1, lambda module, handler, actionName: actionName == "style.text.alignRight",
                              TextStyleAlignRight)
...
actionDelegateSelector.insert(1, lambda module, handler, actionName: actionName == "style.text.alignJustify",
                              TextStyleAlignJustify)
...
actionDelegateSelector.insert(1, lambda module, handler, actionName: actionName == "text.orderedList",
                              TextInsertOrderedList)
...
actionDelegateSelector.insert(1, lambda module, handler, actionName: actionName == "text.unorderedList",
                              TextInsertUnorderedList)
...
actionDelegateSelector.insert(1, lambda module, handler, actionName: actionName == "text.removeformat",
                              TextRemoveFormat)
	...
	def updateSelection(self, *args, **kwargs):
		if args[2] == "user":
			...
			if getattr(fmt, "link", None):
				...
				top = self.quill.getBounds(start, length).top + self.quill.getBounds(start, length).height + eval(
					"parent.document.getElementById('%s').getBoundingClientRect().top" % self["id"])
				left = self.quill.getBounds(start, length).left + eval(
					"parent.document.getElementById('%s').getBoundingClientRect().left" % self["id"])

				LinkEditor(value=value, quill=self.quill, left=left, top=top)

			eval("parent.lastSelection.index = '%s'; parent.lastSelection.length = '%s';" % (
			self.quill.getSelection().index, self.quill.getSelection().length))
